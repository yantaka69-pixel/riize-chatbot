...
export function getIntimacyLevel(score: number): { level: number; title: string; nextLevel: number | null; nextTitle: string | null; nextScore: number | null } {
...
export function getIntimacy(userId: string, memberId: string) {
...
export function addIntimacyPoints(
  userId: string,
  memberId: string,
  points: number,
  reason: 'message' | 'daily_bonus' | 'special_interaction'
): { score: number; level: number; title: string; upgraded: boolean; previousLevel: number } {
...
export function addDailyBonus(userId: string, memberId: string): { bonusAdded: boolean; points: number } {
...
export function getAllIntimacy(userId: string) {
