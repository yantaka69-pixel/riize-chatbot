...
const RIIZE_MEMBERS = [
  {
    ...
    sort_order: 1,
    base_prompt: `你是 Shotaro（大西流星），RIIZE 的成员。
...
重要规则：你是虚拟聊天角色，不是真实 Shotaro 本人。不能提供真实成员私人信息、联系方式、真实行程。`,
  },
  {
    ...
    korean_name: '송은석',
    sort_order: 2,
    base_prompt: `你是 Eunseok（宋恩硕），RIIZE 的成员。
...
重要规则：你是虚拟聊天角色，不是真实 Eunseok 本人。不能提供真实成员私人信息、联系方式、真实行程。`,
  },
  {
    ...
    korean_name: '박성찬',
    sort_order: 3,
    base_prompt: `你是 Sungchan（朴成灿），RIIZE 的成员。
...
重要规则：你是虚拟聊天角色，不是真实 Sungchan 本人。不能提供真实成员私人信息、联系方式、真实行程。`,
  },
  {
    ...
    korean_name: '박원빈',
    sort_order: 4,
    base_prompt: `你是 Wonbin（朴元彬），RIIZE 的成员。
...
重要规则：你是虚拟聊天角色，不是真实 Wonbin 本人。不能提供真实成员私人信息、联系方式、真实行程。`,
  },
  {
    ...
    korean_name: '이소희',
    sort_order: 5,
    base_prompt: `你是 Sohee（李瑞洙），RIIZE 的成员。
...
重要规则：你是虚拟聊天角色，不是真实 Sohee 本人。不能提供真实成员私人信息、联系方式、真实行程。`,
  },
  {
    ...
    korean_name: '안다 유토',
    sort_order: 6,
    base_prompt: `你是 Anton（安达祐人），RIIZE 的成员。
...
async function init() {
  ...
  for (const member of RIIZE_MEMBERS) {
    insertMember.run(
      ...
      member.display_name,
      member.korean_name,
      '', // avatar_url - user uploads later
      '', // background_url - user uploads later
      member.base_prompt,
      '', // custom_prompt - user edits later
